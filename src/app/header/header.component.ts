  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Marco Polello",
        text: "Hello, I'm a Full-stack Web Developer with 2+ years of experience designing web app projects. Find out more in my live-resume!",
